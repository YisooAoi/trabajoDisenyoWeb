  ...
  solicitudXmlHttp.onload = function () {
    ...
    tablaLinks.forEach((fila) => {
      ...
      <td class="itemLista botones">
        ...
        <div class="botonTabla" id="editar" onclick='window.location.href="editor.html?editar=true&id=${fila.identificador}";'> <img class="botonSVG" src="gráficos/pincelEditar.svg" alt="Editar"> </div>
